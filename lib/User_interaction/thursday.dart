...
class ScreenThursday extends StatefulWidget {
  const ScreenThursday({Key? key}) : super(key: key);

  @override
  State<ScreenThursday> createState() => _ScreenThursdayState();
}

class _ScreenThursdayState extends State<ScreenThursday> {
